...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	...
	// MS: changing this to locally packaged jQuery:
	wp_enqueue_script( 'jquery', get_template_directory_uri() . '/assets/components/jquery/dist/jquery.min.js', array(), '2.2.4', false );
